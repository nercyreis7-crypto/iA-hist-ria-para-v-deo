...
# ️ MÍNIMO NECESSÁRIO - só o essencial para o app funcionar
requirements = python3,kivy,requests,urllib3==2.0.7,certifi==2023.11.17,idna==3.6,charset-normalizer==3.3.2
...
# ⚠️ Android 5.0 (Lollipop) - cobre 99% dos celulares
android.minapi = 21
...
# ⚠️ AMBAS as arquiteturas para funcionar em QUALQUER celular
